...
class Control:
    def __init__(self):
        ...
        self.display_trajectory_publisher = rospy.Publiser('/move_group/display_planned_path',
                                                           moveit_msgs.msg.DisplayTrajectory,
                                                           queue_size=5)
    ...
    def move_to_calibrate(self, p):
        ...
        print "============ Moving to calibration point " + p
    ...
    def detect_calibration_marker(self):
        ...
        self.marker_depth = self.depth_img[self.center_x][self.center_y]
